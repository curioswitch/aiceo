...
const config = {
  content: [
    "./src/**/*.{ts,tsx}",
    "./node_modules/@nextui-org/theme/dist/components/(avatar|button|card|chip|dropdown|image|input|link|navbar|select|spinner|ripple|menu|popover|listbox|scroll-shadow).js",
  ],
  darkMode: ["class"],
  plugins: [
    nextui({
