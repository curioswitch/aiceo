...
1985年生まれ。石川県金沢市出身。高校卒業後、東京IT会計・資格の学校TACにて学びファイナンシャルプランナーの資格を獲得。資格の学校TACにて税理士講座の講師を務め、年間200回以上の講義を行う。その傍ら経理代行、融資支援、相続メディア運用などの取り組みを開始。29歳に税理士有資格者となり、SoLaboを設立。
...
採用基準は、「明るく元気で前向きな方大歓迎！」。この基準を満たす人を採用できたので、社員同士が信頼し合い、温かな雰囲気の中で成長し続ける会社へと進化していきました。
